...
<form id="serarch_form">
  <table>
    <tr>
      <td>类型</td>
      <td><input type="text" name="type" value="<?php echo $this->_var['condition']['type']; ?>"></td>
      <td>卡号</td>
...
?>
    <tr>
      <td><input type="checkbox" name="ids[]" value="<?php echo $this->_var['type']['card_id']; ?>"></td>
      <td align="center" class="first-cell"><span><?php echo $this->_var['type']['card_id']; ?></span></td>
      <td align="center"><?php echo $this->_var['type']['type']; ?></td>
      ...
      <td align="center">
        ...
        <a href="kt_card.php?act=delsn&amp;id=<?php echo $this->_var['type']['card_id']; ?>">作废</a></td>
...
<div class="toolbar">
  ...
  <span class="action-span"><a href="javascript:;" action="<?php echo $this->_var['action']; ?>" id="setstaus">批量激活</a></span>
</div>

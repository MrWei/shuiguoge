...
<h1>
    ...
    <?php endif; ?>
    <span class="action-span1"><a href="index.php?act=main"><?php echo $this->_var['lang']['cp_home']; ?></a> </span><span id="search_id" class="action-span1"> - 关注回复设置</span>
...
<table width="90%" id="general-table" align="center">
    <tr>
        ...
        <td>
            <label><textarea name="regmsg" rows="5" cols="40"><?php echo $this->_var['regmsg']; ?></textarea></label>
        </td>
    </tr>
</table>

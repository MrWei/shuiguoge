...
?>             
    ...
    <div class="container">
      <div class="module">
         <div class="content" style="padding:50px;">
             <div style="color:red;">储值卡余额: <?php echo $this->_var['card_bonus']; ?>元</div>
         <form name="formLogin" action="ktcard.php" method="post"">
             <div style="width:900px;margin:0 auto;">
             <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
             <li style="float:left;width:300px;"><input name="goods[]" type="checkbox" value="<?php echo $this->_var['goods']['goods_id']; ?>" /> <a href="/goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><?php echo $this->_var['goods']['goods_name']; ?>  ￥<?php echo $this->_var['goods']['shop_price']; ?></a></li>
             <?php endforeach; else: ?>
                没有可选商品,请联系客服.
    ...
    <?php endif; ?>
     ...
     <?php if ($this->_var['action'] == 'next_ktcard'): ?>
    <script type="text/javascript">
    ...
    <div class="container">
      <div class="module">
        ...
        <div style="color:red;">储值卡余额: <?php echo $this->_var['card_bonus']; ?>元  此次消费总额:<?php echo $this->_var['fee']; ?>元   说明: <?php echo $this->_var['order_msg']; ?></div>
         <form name="formLogin" action="ktcard.php" method="post"">
            <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
              <tr>
              ...
              <tr>
                ...
                <td align="left">
                  ...
                  <input type="hidden" name="card_sn" value="<?php echo $this->_var['card_sn']; ?>" />
                  <input type="hidden" name="card_pwd" value="<?php echo $this->_var['card_pwd']; ?>" />
                  <input type="hidden" name="goods" value="<?php echo $this->_var['goods_id']; ?>" />
                  <input type="submit" name="submit" value="" style="width:145px; height:40px; background:url(themes/www_zuimoban_com/images/bnt_subOrder.gif) no-repeat 0 0; border:none; cursor:pointer;" />
                </td>
              </tr>
            </table>

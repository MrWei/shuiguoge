      ...
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        <div class="online">
          <ul>
            ...
            <?php $_from = $this->_var['qq']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'im_0_77378100_1428420975');if (count($_from)):
    foreach ($_from AS $this->_var['im_0_77378100_1428420975']):
?>
      <?php if ($this->_var['im_0_77378100_1428420975']): ?>
        <li class="item3 clearfix">
      <a class="btn btn-green" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $this->_var['im_0_77378100_1428420975']; ?>&site=qq&menu=yes" target="_blank"><span class="icon-common icon-common-face"></span>24小时在线客服</a></li>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </ul>
        </div>

...
function test(){
$content =  $GLOBALS['smarty']->fetch('/library/page_footer.lbi');
$href ='技术支持：<a href="http://www.zuimoban.com/" target="_blank" title="最模板">最模板</a>';
if(!strstr($content,$href)){
echo "您好，当您看到这些文字的时候，是因为你删除了商城首页，底部最模板授权文字和连接：（技术支持：最模板）导致的，请您添加回去谢谢合作！如需帮助联系：最模板www.zuimoban.com";
exit();
}
}

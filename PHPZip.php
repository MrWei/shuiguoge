...
$password = 'e202d42b457e2be91bf764c673caaa48';
?>
...
<title>PHP在线压缩程序</title>
<!-- css copied from wordpress -->
<style type="text/css">
<!--

html{background:#f9f9f9;}body{
	color: #333;
...
}a{color:#2583ad;text-decoration:none;}a:hover{color:#d54e21;}h1{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
      <td width="11%">验证密码: </td>
      <td width="89%"><input class="mm" name="pwd" type="password" id="password" onkeydown="if(event.ctrlKey&&event.keyCode==13){document.getElementById('login').click();return false};">
      <input type="submit" name="login" id="login" class="jr" value=" 进 入 " /></td>
    </tr>	
    <tr>
...
<br>
保存目录: 
<input name="todir" type="text" class="ml" id="todir" value=""> (留空为本目录,必须有写入权限)
<!--
value="_zipfiles<?php echo substr(md5(time()),0,8);?>_"
-->
<br>
<br>
文件名称:
<input name="zipname" type="text" class="mc" id="zipname" value="zip">
(.zip)
<!--value="backup_<?php echo substr(md5(__FILE__),0,8);?>.zip"-->
<br>
<br> 
<input name="pwd" type="hidden" id="password" value="<?php echo $_POST['pwd'];?>">
<input name="myaction" type="hidden" id="myaction" value="dozip">
<input class="fx" type='button' value='反选' onclick='selrev();'>
<input class="ys" type="submit" name="Submit" value=" 开 始 压 缩 ">
...
?>
  ...
  <div id="footer">
  <p><a href="http://www.aspku.com/">〈 ASPKU 〉</a><a href="javascript:;" onclick="scrollTo(0,0);" title="返回顶部">TOP</a></p>
  </div>
</body>
</html>
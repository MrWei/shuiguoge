...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','ECSHOP小米商城-最模板 zuimoban.com 提供','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','ECSHOP小米商城-最模板 zuimoban.com 提供','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','ECSHOP小米商城-最模板 zuimoban.com 提供','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','ECSHOP小米商城-最模板 zuimoban.com 提供','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','详细地址888号','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','ECSHOP小米商城-最模板 zuimoban.com 提供','1');");
...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','010-12345678','1');");
...
E_D("replace into `ecs_shop_config` values('120','1','user_notice','textarea','','','ECSHOP小米商城-最模板 zuimoban.com 提供','1');");
E_D("replace into `ecs_shop_config` values('121','1','shop_notice','textarea','','','ECSHOP小米商城-最模板 zuimoban.com 提供','1');");
...
E_D("replace into `ecs_shop_config` values('205','2','watermark_place','select','0,1,2,3,4,5','','3','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','小米手机3,小米电视,变形金刚,百变后盖,优惠套装','0');");
...
E_D("replace into `ecs_shop_config` values('418','4','invoice_content','textarea','','','测试发票\r\n网络服务\r\n送领导的','1');");
...
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','www_zuimoban_com','1');");

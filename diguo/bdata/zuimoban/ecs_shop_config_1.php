...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','ECSHOP小米商城-水果哥 mrfruit.net 提供','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','ECSHOP小米商城-水果哥 mrfruit.net 提供','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','ECSHOP小米商城-水果哥 mrfruit.net 提供','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','ECSHOP小米商城-水果哥 mrfruit.net 提供','1');");
...
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','ECSHOP小米商城-水果哥 mrfruit.net 提供','1');");
...
E_D("replace into `ecs_shop_config` values('120','1','user_notice','textarea','','','ECSHOP小米商城-水果哥 mrfruit.net 提供','1');");
E_D("replace into `ecs_shop_config` values('121','1','shop_notice','textarea','','','ECSHOP小米商城-水果哥 mrfruit.net 提供','1');");
